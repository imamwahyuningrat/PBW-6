...
<html lang="en">
    ...
    <meta name="author" content="masszehbakti">
...
<body>
    <div class="container-fluid">
        <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-whiteborder-bottom shadows-sm">
            <hs class="my-0 mr-md-auto font-weight-normal"><i class="fas fa-user tittle-icon"></i> Data Siswa</hs>
    </div>
</div>
    ...
    <footer class="pt-4 my-md-4 pt-md-3 border-top">
        <div class="row">
            <div class="col-12 col-md center">
                &copy; 2022 - <a class="text-info" href="https://stmik-sumedang.ac.id/">STMIK Sumedang</a>
            </div>
        </div>
    </footer>
</div>
...
<xscipt type="text/javascript" src="assets/plugins/bootstrap-4.1.3/js/bootstrap.min.js"></script>
